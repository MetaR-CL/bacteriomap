...
export function getSystemPalette(systemId) {
  try {
...
export function MorphoSVG({ kind, size = 100, stroke = 'var(--violet)', fill = 'var(--violet)', fillOpacity = 0.22, strokeWidth = 1.5, vivid = false, gradId = 'g' }) {
  const r = size / 2;
  const cx = r, cy = r;
