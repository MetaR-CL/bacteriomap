// editorial-sheet.jsx — Fiche bactérie, refonte densité quotidienne
...
// ──────────────────────────────────────────────────────────
// Multi-slot image hook (extends useBactImage to slot index)
...
// ──────────────────────────────────────────────────────────
// Section heading (denser than before)
...
// ──────────────────────────────────────────────────────────
function SheetScreen({ navigate, bacteriaId, systemId = 'orl', vivid = false, showImages = true }) {
  const b = SPN;
  const c = window.gramColor(b.gram);
  const palette = window.getSystemPalette(systemId);
